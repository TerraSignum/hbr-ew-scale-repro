...
output
\pyown{outputs/verify_S_bounce_structural_rational.json}{verify_S_bounce_structural_rational.json}).
The leading integer
...
\pyown{data/saddle_blindness_witness.json}{saddle_blindness_witness.json} records the
...
\pyown{data/g_path_msbar.json}{g_path_msbar.json} and the parent-corpus
...
\pyown{outputs/eta_S_high_precision_audit.json}{eta_S_high_precision_audit.json}.
...
\pyown{outputs/eta_S_high_precision_audit.json}{eta_S_high_precision_audit.json}) cross-validates
...
\pyown{outputs/verify_S_bounce_from_KQ_closed_potential.json}{verify_S_bounce_from_KQ_closed_potential.json}.
\begin{equation}
\langle F\rangle(N)
...
\pyown{data/v5_g_consensus.json}{v5_g_consensus.json}.
